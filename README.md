...
## other helpful pages to solve problems that I encountered on the way:

activate python environment for flask project
...
pip install python-dotenv #definitely his one
pip  install flask

Questions: 
if, when starting the virtual python environment, I get messages like "ModuleNotFoundError: No module named 'OpenSSL'"
, should I - in this case - add OpenSSL to the requirement.txt file? 