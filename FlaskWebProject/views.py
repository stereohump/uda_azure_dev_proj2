...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        app.logger.info("Posting successfully created.")
...
def post(id):
    ...
    if form.validate_on_submit():
        ...
        app.logger.info("Posting successfully changed.")
        return redirect(url_for('home'))
    return render_template(
        'post.html',
        title='Edit Post',
...
def login():
    ...
    if form.validate_on_submit():
        ...
        app.logger.info("User succefully logged in.")
...
def authorized():
    ...
    if request.args.get('code'):
        ...
        login_user(user)
        app.logger.info('login successful via Microsoft account')
        _save_cache(cache)
    return redirect(url_for('home'))
